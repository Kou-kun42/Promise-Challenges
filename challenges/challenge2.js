 ...
 *
 *  It will return two strings, "Hello there, Ducky" and "MAKE SCHOOL IS AWESOME!!!"
 *  This was correct
 *
 *
 ...
 *
 *  The code gets an error, but thanks to the resolves/rejects and the catch
 *  we're able to avoid an error that would make the code stop midway.
 *  It returns:
 *  Received an error!
 ...
 *    run the code again.
 *
 *  Almost the same thing happens, except since greet() is called before
 *  uppercaser() we get the Ducky greeting first, and then the same error message.
 *
 *
